                ...
                <div className="bg-white rounded-lg overflow-hidden flex flex-col relative h-full" style={{ boxShadow: '0 1px 1px rgba(0, 0, 0, 0.03)' }}>
                  ...
                  <div className="p-1.5 flex-1 flex flex-col bg-white">
                    ...
                    <div
                      ...
                      className="w-full bg-neutral-100 text-black text-[8px] font-medium py-0.5 rounded-lg flex items-center justify-between px-1 hover:bg-neutral-200 transition-colors mt-auto cursor-pointer"
                    >
