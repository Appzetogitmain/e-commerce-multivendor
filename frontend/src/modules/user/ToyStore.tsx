              ...
              return (
                ...
                >
                  ...
                  <div className="p-1.5 flex-1 flex flex-col" style={{ background: '#fef9e7' }}>
                    ...
                    <Link
                      to={`/category/toys`}
                      className="w-full bg-neutral-100 text-black text-[8px] font-medium py-0.5 rounded-lg flex items-center justify-between px-1 hover:bg-neutral-200 transition-colors mt-1"
                    >
